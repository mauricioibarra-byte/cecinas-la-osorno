      ...
      <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <Button variant="link" className="p-0 h-auto mt-2 text-primary" asChild>
                  <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <a href="tel:+56912345678" className="block text-foreground/70 hover:text-primary transition-colors">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative h-96 bg-muted/30 rounded-lg overflow-hidden border border-border">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100234.56!2d-73.150!3d-40.574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9617cf1f8c1b7b1f%3A0x1b1f1f1f1f1f1f1f!2sOsorno%2C%20Los%20Lagos%2C%20Chile!5e0!3m2!1ses!2scl!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
